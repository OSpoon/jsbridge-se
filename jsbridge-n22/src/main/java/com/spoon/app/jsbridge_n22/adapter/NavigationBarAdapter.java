 ...
 * 自定义导航栏的适配器
 */
public class NavigationBarAdapter extends BaseQuickAdapter<NavigationBarDataBean.NavigationBarBean.ChangeRightImageBean
        , BaseViewHolder> {
    ...
    @Override
    protected void convert(BaseViewHolder holder, NavigationBarDataBean.NavigationBarBean.ChangeRightImageBean bean) {
