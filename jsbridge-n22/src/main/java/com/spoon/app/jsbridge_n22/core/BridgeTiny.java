...
import static com.spoon.app.jsbridge_n22.core.BridgeUtil.JAVA_SCRIPT;
...
public class BridgeTiny {
    ...
    public void webViewLoadJs(IWebView view) {
        ...
        view.loadUrl(String.format(BridgeUtil.JAVASCRIPT_STR,BridgeUtil.webViewLoadLocalJs(view,JAVA_SCRIPT)));
